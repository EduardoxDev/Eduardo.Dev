...
export const EXPERIENCE: Experience[] = [
  {
    ...
    roleKey: 'exp_nyxo_role',
    period: '2026 — Present',
    location: 'Remote',
    descriptionKey: 'exp_nyxo_desc',
    tech: ['TypeScript', 'Next.js', 'React', 'PostgreSQL', 'Redis', 'CDN', 'Analytics'],
    impactKeys: ['exp_nyxo_i1', 'exp_nyxo_i2', 'exp_nyxo_i3', 'exp_nyxo_i4'],
  },
  {
